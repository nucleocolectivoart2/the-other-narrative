...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className={cn(
        "fixed bottom-8 left-8 z-[100] md:bottom-12 md:left-12",
        "flex items-center justify-center w-16 h-16 rounded-full bg-[#25D366] text-white shadow-2xl transition-all duration-500 hover:scale-110 active:scale-95 group overflow-hidden"
      )}
    ...
    >
      ...
      <div className="absolute -z-10 w-full h-full bg-[#25D366] rounded-full animate-ping opacity-20" />
    </a>
  );
}
