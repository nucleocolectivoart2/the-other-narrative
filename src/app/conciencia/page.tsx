...
import { ArrowLeft, ArrowRight, ShieldCheck, Target, Award } from 'lucide-react';
      ...
      <div className="section-container py-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-24">
          <div className="lg:col-span-7 space-y-12">
            <h2 className="text-3xl font-bold font-headline tracking-tighter">El Desafío</h2>
          ...
          <div className="lg:col-span-5 bg-muted/20 p-12 space-y-8 rounded-sm h-fit border border-border/40">
