...
const featuredVideos = [
  ...
  { id: 'VzQC-PPZmKQ', title: 'Conferencia: Narrativas que Movilizan', thumbnail: 'https://img.youtube.com/vi/VzQC-PPZmKQ/maxresdefault.jpg' },
...
export default function HomePage() {
  ...
  const desafioImage = PlaceHolderImages.find(img => img.id === 'desafio-image');
    ...
    <div className="flex flex-col min-h-screen bg-background relative selection:bg-primary/30 overflow-x-hidden">
      ...
      <div className={cn(
        ...
        <div className="space-y-6 text-center">
          <h2 className="text-3xl font-headline italic tracking-widest text-primary lowercase">the other narrative.</h2>
      ...
      {isLoaded && (
        <div className="fixed inset-0 z-[150] pointer-events-none flex items-center justify-center animate-impact-splash">
           <div className="text-center">
              <h1 className="text-6xl md:text-[80px] lg:text-[104px] font-bold font-headline leading-[0.85] text-white tracking-tighter lowercase">
                the other
              </h1>
              <h1 className="text-6xl md:text-[80px] lg:text-[104px] font-normal font-headline leading-[0.85] text-primary italic tracking-tighter lowercase">
                narrative.
              </h1>
           </div>
        </div>
      ...
      <section id="hero" className="relative h-screen w-full flex items-center overflow-hidden bg-black">
        <div className="absolute inset-0 z-0">
          <div 
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[110%] h-[110%] min-w-full min-h-full"
            style={{ transform: `translate(-50%, calc(-50% + ${scrollY * 0.05}px))` }}
          >
            <iframe
              src="https://www.youtube.com/embed/ooZZ0i_1_gU?autoplay=1&mute=1&controls=0&loop=1&playlist=ooZZ0i_1_gU&start=12&end=114&background=1&modestbranding=1&rel=0&iv_load_policy=3&disablekb=1"
              className="absolute top-0 left-0 w-full h-full object-cover brightness-[0.45] grayscale-[0.2]"
        ...
        <div className="section-container relative z-20 w-full pt-20">
          <div className="max-w-6xl space-y-10">
            ...
            {/* Logo / Marca */}
            <div className={cn(
              "flex flex-col items-start min-h-[100px] md:min-h-[160px]",
              isLoaded ? "animate-layout-entry" : "opacity-0"
            )}>
              <h1 className="text-6xl md:text-[80px] lg:text-[135px] font-bold font-headline leading-[0.85] text-white tracking-tighter lowercase">
                the other
              </h1>
              <h1 className="text-6xl md:text-[80px] lg:text-[135px] font-normal font-headline leading-[0.85] text-primary italic tracking-tighter lowercase">
                narrative.
              </h1>
            </div>
            ...
            <div className={cn(
              ...
              <span className="bg-primary text-white font-bold text-[9px] md:text-[10px] tracking-[0.4em] uppercase px-4 py-2 shadow-2xl">
                LABORATORIO ESTRATÉGICO Y EDITORIAL
              </span>
            </div>

            {/* Mensajes Principales - Sin Cuadros y con interlineado reducido */}
            <div className="space-y-6 max-w-5xl">
              <div className={cn(
                "flex flex-col gap-1",
                isLoaded ? "animate-stagger-2" : "opacity-0"
              )}>
                <p className="text-base md:text-xl lg:text-[22px] text-white font-bold tracking-tight leading-tight">
              ...
              {/* Texto Descriptivo - Reducido 30% */}
              <div className={cn(
                "border-l-2 border-primary/60 max-w-2xl mt-8 pl-6",
              ...
              <div className="flex flex-wrap gap-4 pt-8">
                <Link 
                  href="/blog" 
                  className={cn(
                    "btn-editorial bg-primary text-white hover:bg-white hover:text-primary border-0 h-10 px-8 text-[9px] tracking-[0.3em] font-bold shadow-2xl",
                ...
                <button 
                  ...
                  className={cn(
                    "btn-editorial border-white/60 text-white hover:bg-white/10 h-10 px-8 text-[9px] tracking-[0.3em] font-bold backdrop-blur-md group",
                    isLoaded ? "animate-stagger-5" : "opacity-0"
                  )}
                >
                  NUESTRA MIRADA <ArrowRight className="ml-4 h-3 w-3 group-hover:translate-x-1 transition-transform" />
                </button>
              </div>
            </div>
          </div>
      ...
      <section id="mission" className="section-container py-32 md:py-48 overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-start">
          <div className="lg:col-span-5 w-full">
            <div className="relative aspect-[3/4] w-full overflow-hidden rounded-sm shadow-2xl bg-muted">
              <Image
                src={desafioImage?.imageUrl || "https://picsum.photos/seed/editorial-articulation/800/1200"}
          ...
          <div className="lg:col-span-7 space-y-12">
            <div className="space-y-6">
              ...
              <h2 className="text-4xl md:text-6xl font-bold font-headline leading-[1.1] tracking-tighter text-foreground">
                Articular <br />
            ...
            <div className="space-y-8 max-w-2xl">
              ...
              <div className="border-l-2 border-primary/20 pl-8 space-y-6 py-2">
      ...
      {/* Secciones para anclajes del Navbar */}
      <section id="areas" className="section-container py-32 border-t">
         <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
            <div className="space-y-8">
              <span className="text-primary font-bold text-[10px] tracking-[0.6em] uppercase">ÁREAS DE TRABAJO</span>
              <h2 className="text-4xl md:text-6xl font-bold font-headline tracking-tighter">Impacto <br /><span className="italic font-normal text-primary">Estratégico.</span></h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                ...
                <div key={idx} className="p-8 border bg-white rounded-sm hover:border-primary transition-colors">
      ...
      <section id="proceso" className="section-container py-32 border-t">
         <div className="max-w-4xl space-y-12">
            <span className="text-primary font-bold text-[10px] tracking-[0.6em] uppercase">METODOLOGÍA</span>
            <h2 className="text-4xl md:text-6xl font-bold font-headline tracking-tighter">Escuchar. Priorizar. <br /><span className="italic font-normal text-primary">Movilizar.</span></h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pt-8">
               {[
                 { step: '01', title: 'Escuchar', desc: 'Comprender el contexto y las prioridades reales.' },
                 { step: '02', title: 'Diseñar', desc: 'Construir herramientas para conectar.' },
                 { step: '03', title: 'Movilizar', desc: 'Generar conversaciones que impulsen la confianza.' },
               ].map((item, idx) => (
                 <div key={idx} className="space-y-4">
                    <span className="text-4xl font-headline italic text-primary/20 font-bold">{item.step}</span>
      ...
      <section className="py-32 bg-black text-white overflow-hidden">
        <div className="section-container mb-24">
          <div className="space-y-6">
            ...
            <h2 className="text-4xl md:text-6xl font-bold font-headline tracking-tighter">Multimedia.</h2>
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 bg-black border-t border-l border-white/5">
                ...
                <div className="group relative bg-black aspect-square overflow-hidden cursor-pointer border-r border-b border-white/5">
                  ...
                  <div className="absolute inset-0 z-10 p-12 flex flex-col justify-between">
                    <div className="space-y-6">
                      ...
                      <h3 className="text-2xl md:text-3xl font-bold font-headline tracking-tighter leading-tight group-hover:text-primary transition-colors">
                        {video.title}
                      </h3>
                    </div>
